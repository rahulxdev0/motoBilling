            ...
            <div class="py-4">
                <div class="md:flex md:items-center md:justify-between">
                    <div class="flex-1 min-w-0">
                        <h1 class="text-2xl text-gray-900 sm:text-2xl sm:truncate">
                            Invoice Management
                        </h1>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">₹{{ number_format($stats['outstanding'], 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if($invoice->balance_amount > 0)
                                        <div class="text-sm text-red-600">Balance: ₹{{ number_format($invoice->balance_amount, 2) }}</div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @endphp
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $paymentColors[$invoice->payment_status] ?? 'bg-gray-100 text-gray-800' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <!-- Duplicate Button -->
                                        <button type="button" 
                                                wire:click="duplicateInvoice({{ $invoice->id }})"
