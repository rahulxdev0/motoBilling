            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Create a new sales invoice for your customer</p>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    @error('partie_id') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                                </div>
                                <div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($invoice_items as $index => $item)
                                        <tr>
                                            <td class="px-6 py-4">
                                                <select wire:model="invoice_items.{{ $index }}.product_id" 
                                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea wire:model="terms_conditions" 
                                              rows="3" 
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                <div class="bg-blue-50 rounded-lg p-4">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-blue-800">Invoice Total</p>
                                            <p class="text-xs text-blue-600">Amount payable by customer</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
