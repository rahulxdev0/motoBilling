<div class="flex-1 p-6 bg-gray-50 overflow-y-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-4">
                ...
                <button wire:click="handleCreateItem"
                    class="bg-[#153B50] text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <button wire:click="openAddCategoryModal"
                        class="bg-[#153B50] text-white px-3 py-2 rounded-lg flex items-center space-x-1 transition-colors whitespace-nowrap">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
    ...
    <livewire:items.components.create-product-modal />
</div>