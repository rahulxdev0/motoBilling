                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2 mt-3">
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <div class="flex gap-2">
                                            <button type="button" 
                                                wire:click="generateBarcodeLabel"
                                                class="flex items-center px-3 py-1.5 bg-[#153B50] text-white text-sm rounded-md hover:bg-[#0e2a3a] focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200"
                                                {{ (!$barcode || !$name) ? 'disabled' : '' }}
                                                title="{{ (!$barcode || !$name) ? 'Enter barcode and product name first' : 'Generate barcode label' }}">
                                            ...
                                            <input type="number" min="1" wire:model="barcodePrintQty"
                                                ...
                                                placeholder="Qty" title="Print Quantity">
                                            <button type="button"
                                                class="flex items-center px-3 py-1.5 bg-green-600 text-white text-sm rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors duration-200"
                                                onclick="printMultipleBarcodeLabels()"
                                                {{ (empty($barcodeLabel) || !$barcodePrintQty || $barcodePrintQty < 1) ? 'disabled' : '' }}>
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    @if(isset($barcodeLabel))
                                        <div class="border border-gray-200 rounded-md p-4 bg-white">
                                            <div class="flex flex-wrap gap-4" id="barcodeLabelPreviewMultiple">
                                                @for($i = 0; $i < ($barcodePrintQty ?? 1); $i++)
                                                    <div class="flex flex-col items-center mb-2 barcode-label-single">
                                                        {!! $barcodeLabel !!}
                                            ...
                                            <div class="flex justify-center mt-3">
                                                <button type="button" 
                                                    id="printBarcodeBtn"
                                                    class="flex items-center px-3 py-1.5 bg-gray-100 text-gray-700 text-sm rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-colors duration-200">
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                            d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                                                </svg>
                                ...
                                @else
                                    <div class="border border-gray-200 border-dashed rounded-md p-6 bg-gray-50 flex flex-col items-center justify-center text-center">
                                        <svg class="w-12 h-12 text-gray-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                        </svg>
                                        <p class="text-sm text-gray-500">
                                            Enter barcode and product name, then click "Generate Label" to see a preview
                                        </p>
                                    </div>
                                @endif
                            </div>
