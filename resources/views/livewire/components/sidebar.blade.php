...
<div class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col h-full rounded-md">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <!-- Dashboard -->
        <a wire:navigate href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 text-gray-700 bg-teal-50 border-r-4 border-teal-500 rounded-l-lg hover:bg-teal-100 transition-colors duration-200">
        ...
        <!-- Customers -->
        <a wire:navigate href="{{ route('parties.manage') }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200">
        ...
        <div class="space-y-1">
            ...
            @if($isItemsOpen)
                <div class="ml-4 space-y-1 transition-all duration-200 ease-in-out">
                    <!-- Inventory -->
                    <a wire:navigate href="{{ route('items.manage') }}" class="flex items-center px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200 border-l-2 border-gray-200">
        ...
        <!-- Invoices -->
        <a wire:navigate href="{{ route("invoice.manage") }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
