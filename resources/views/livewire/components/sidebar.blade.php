...
<div class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col h-full rounded-md">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <!-- Customers -->
        <a href="{{ route('parties.manage') }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200">
