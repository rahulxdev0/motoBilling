<div>
    @if($isMobileOpen)
        <div class="fixed inset-0 bg-black/50 bg-opacity-50 z-40 sm:hidden" wire:click="closeMobile"
    ...
    <div class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col h-screen md:h-[98vh] rounded-md 
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-lg font-bold text-teal-700">{{ $company ? $company->name : 'MotoBilling' }}</h1>
