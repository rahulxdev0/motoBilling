<div class="flex-1 p-6 bg-gray-50 overflow-y-auto">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Create New Party</h1>
                    <p class="text-gray-600 mt-1 text-sm">Add a new business party to your system</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            ...
            <p class="text-sm text-gray-600">Fill in the details for the new party</p>
        </div>
