<div class="flex-1 p-6 bg-white overflow-y-auto rounded-md">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <button wire:click="refreshData" class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                        ...
                        @foreach($lowStockItems as $item)
                            <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                                <div>
                                    ...
                                    <p class="text-sm text-red-600">Only {{ $item['current_stock'] }} {{ $item['unit'] }} left</p>
                                </div>
                                <div class="text-right">
                    ...
                    <button class="w-full mt-4 bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-lg transition-colors">
                        Reorder Items
                    </button>
                </div>
            </div>
                        ...
                        @foreach($stockItems as $stock)
                            <div class="p-4 bg-gray-50 rounded-lg">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="font-medium text-gray-900">{{ $stock['category'] }}</h3>
                                    <span class="text-sm font-semibold text-gray-900">${{ number_format($stock['value'], 0) }}</span>
                                </div>
                                <div class="flex justify-between text-sm text-gray-600">
                                    <span>{{ $stock['total_items'] }} items</span>
                                    @if($stock['low_stock'] > 0)
                                        <span class="text-red-600">{{ $stock['low_stock'] }} low stock</span>
                                    @else
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <button class="w-full bg-teal-500 hover:bg-teal-600 text-white py-3 px-4 rounded-lg flex items-center justify-center space-x-2 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                            <span>Create Invoice</span>
                        </button>
                        <button class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 rounded-lg flex items-center justify-center space-x-2 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
