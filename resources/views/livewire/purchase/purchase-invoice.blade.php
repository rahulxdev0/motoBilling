                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <button type="button"
                                                ...
                                                wire:confirm="Are you sure you want to delete this purchase invoice? This action cannot be undone."
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900 mb-2">No purchase invoices
                                                found</h3>
                                            <p class="text-gray-500 mb-4">Get started by creating your first purchase
                                                invoice.</p>
